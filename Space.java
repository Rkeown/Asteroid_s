...
public class Space extends World
{
    ...
    /**
     * paintStars tells the world to "paint" a bunch of stars all over the world
     * @param there is an int param that counts the stars
    ...
    private void prepareGame()
    {
        ...
        addAsteroids(Greenfoot.getRandomNumber(5)+1);
    }
    /**
     * addAsteroids add asteroids to the world
     * @param there is an int that counts how many asteroids there are in the world
     * @return there are no returns
     */
