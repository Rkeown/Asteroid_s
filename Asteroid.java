...
public class Asteroid extends SmoothMover
{
     ...
     */
    /**
     * setSize sets the size for the asteroids
     * @param there is an int parameter that sets the size
    ...
    /**
     * hit tells the game how much damage an asteroid takes when hit
     * @param there is an int parameter the sets the damage
     * @return there are no returns
     */
     ...
     */
    /**
     * breakUp tells the asteroids how to breakup
     * @param there is an int parameter that counts how many times the asteroids break ups
     * @return there are no returns 
     */
